    ...
    <div class="bg-white shadow-lg rounded-lg w-full max-w-4xl flex overflow-hidden">
        ...
        <div class="w-1/2 p-10">
            ...
            <form id="register-form" method="POST" action="{{ route('register') }}" class="hidden">
                @csrf
                <input type="text" name="name" placeholder="Nama Lengkap" class="w-full mb-4 p-2 border rounded"
                    required value="{{ old('name') }}" />
                <input type="text" name="nim" placeholder="NIM" class="w-full mb-4 p-2 border rounded"
                    value="{{ old('nim') }}" />
                <input type="text" name="whatsapp" placeholder="No. WhatsApp" class="w-full mb-4 p-2 border rounded"
                    value="{{ old('whatsapp') }}" />
                ...
                <input type="password" name="password" id="reg-password" placeholder="Password"
                    class="w-full mb-1 p-2 border rounded" required />
