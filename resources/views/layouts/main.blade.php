...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="{{ route('loans.returns') }}"
            class="{{ request()->is('loans/returns') ? 'active' : '' }}">Pengembalian</a>
        ...
        <div class="topbar">
            ...
            <div style="display: flex; align-items: center; gap: 12px;">
                ...
                <a href="{{ route('notifications.index') }}" style="position: relative; text-decoration: none;">
                    ...
                    @if ($notifCount > 0)
                        <span
                            style="position: absolute; top: -6px; right: -6px; background: red; color: white; border-radius: 50%; padding: 2px 6px; font-size: 11px;">
                            {{ $notifCount }}
                        </span>
                    @endif
                </a>
